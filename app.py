...
def show_latest_articles():
    ...
    url = (
        'https://newsapi.org/v2/top-headlines?' 'language=en' 'qinTitle=query' 'apiKey={API_SECRET_KEY}')
...
def show_world_news():
    ...
    url = (
        'https://newsapi.org/v2/top-headlines?' 'language=en' 'qinTitle=query' 'pageSize=20' 'apiKey={API_SECRET_KEY}')
    res = requests.get(url)
